...
class Solution {
    public static int minDays(int[] bloomDay, int m, int k) {
        ...
        while (l <= r) {
            int mid = l + (r - l) / 2;
            int flowersMade = noOfBotiqueMade(bloomDay, k, mid);

            System.out.println("FLOWERS FOR BLOOM DAY : " + mid + " IS ::: " + noOfBotiqueMade(bloomDay, k, mid));
        ...
        System.out.println("PPPPPPPPPPPPPPPPP ::::::" + l + "  " + r);
        return l;
    }

    public static int noOfBotiqueMade(int[] bloomDay, int k, int day) {
        int adjacentCount = 0, flowersMade = 0;
