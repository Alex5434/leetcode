...
class MergeSort {
    ...
    public static void mergeSortHelper(int[] arr, int[] aux, int left, int right) {
        ...
        // System.out.println("GOING TO SPLIT << " + left + " || " + mid + " >> " +
        // right);
        if (left >= right) {
            // System.out.println("GOING TO RETURN << " + left + " || " + mid + " >> " +
            // right + " ## " + arr[left]);
            return;
        }
        ...
        // System.out.println("CAME UNDER THE ORIGINAL MERGE ::: " +
    ...
    public static void originalMerge(int[] arr, int[] aux, int left, int mid, int right) {
        ...
        System.out.println(
                "AFTER MERGE :::::: " + Arrays.toString(arr) + " :: " + " :: " + left + " :: " + mid + " :: " + right);
    }
