...
class Solution {
    ...
    // a walks list A
    // b walks list B
    // They reach the end at different times.
    // Phase 2: Switch heads (THIS IS THE MAGIC)
    // When a reaches null:
    // a = headB;
    // When b reaches null:
    // b = headA;
    // Now:
    // a has walked lenA + lenB
    // b has walked lenB + lenA
    // ➡️ Same distance


    // 📝 One of the optimal solutions I have learned so far great apporach
    // Though It is not kicked in my mind, copied from leetcode solutions
